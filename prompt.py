...
"reason": "The week starting (2021-12-13) saw a higher shipped revenue compared to previous weeks. This could be due to the holiday season where people tend to buy more. The return units are also significantly higher, which could be due to more purchases leading to more returns.",
"reason_html": "The week starting (<span style='font-weight:bold;'>2021-12-13</span>) saw a <span style='font-weight:bold;'>higher</span>  <span style='font-weight:bold;'>Shipped Revenue</span> compared to previous weeks. This could be due to the holiday season where people tend to buy more. The <span style='font-weight:bold;'>Return units</span> are also significantly <span style='font-weight:bold;'>higher</span>, which could be due to more purchases leading to more returns."

"anomaly_date":"2021-11-29",
"reason": "The week starting (2021-11-29) saw a high booked revenue, though not as high as the previous week. This could be due to the continued effect of the sales events in the previous week. The shipped units are also significantly higher than the previous week, indicating more products were sold and shipped.",
"reason_html": "The week starting (<span style='font-weight:bold;'>2021-11-29</span>) saw a <span style='font-weight:bold;'>high</span> <span style='font-weight:bold;'>Booked Revenue</span>, though not as <span style='font-weight:bold;'>high</span> as the previous week. This could be due to the continued effect of the sales events in the previous week. The shipped units are also significantly <span style='font-weight:bold;'>higher</span> than the previous week, indicating more products were sold and shipped."
